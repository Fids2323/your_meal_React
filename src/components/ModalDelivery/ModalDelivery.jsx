					...
					<div className={style.container}>
						...
						<form className={style.form} id="delivery" onSubmit={handleSubmit}>
							<fieldset className={style.fieldset}>
								<input className={style.input} type="text" name="name" value={form.name} placeholder="Ваше имя" onChange={handleInputChange} />
								<input className={style.input} type="tel" name="phone" value={form.phone} placeholder="Телефон" onChange={handleInputChange} />
							</fieldset>
							...
							{form.format === "delivery" && (
								<fieldset className={style.fieldset}>
									<input className={style.input} type="text" name="address" value={form.address} placeholder="Улица, дом, квартира" onChange={handleInputChange} />
									<input className={classNames(style.input, style.input_half)} type="number" name="floor" value={form.floor} placeholder="Этаж" onChange={handleInputChange} />
									<input
